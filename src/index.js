...
function initSimulations() {
  ...
  simulationNodes = force
    ...
    .force(
      "x",
      force
        .forceX(d => (d.group && d.group.x ? d.group.x : width / 2))
        .strength(0.05)
    )
    .force(
      "y",
      force
        .forceY(d => (d.group && d.group.y ? d.group.y : height / 2))
        .strength(0.05)
    )
...
function update(e) {
  ...
  currentComparison = e
    ? e.detail.closestMark.el.dataset.comparison
    : currentComparison;
